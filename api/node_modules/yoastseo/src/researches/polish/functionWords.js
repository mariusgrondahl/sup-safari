...
exports.default = function () {
	return {
		...
		filteredAtEnding: [].concat(ordinalNumerals, generalAdjectives, generalAdverbs, delexicalisedVerbsInfinitive, otherAuxiliariesInfinitive, passiveAuxiliariesInfinitive),

		// These word categories are filtered at the beginning and ending of word combinations.
		filteredAtBeginningAndEnding: [].concat(prepositions, coordinatingConjunctions, demonstrativePronouns, quantifiers, intensifiers, possessivePronouns, reflexivePronounsNominative, reflexivePronounsOther),

		// These word categories are filtered everywhere within word combinations.
		filteredAnywhere: [].concat(transitionWords, additionalTransitionWords, cardinalNumerals, personalPronounsNominative, personalPronounsAccusative, personalPronounsGenitive, personalPronounsDative, personalPronounsInstrumental, personalPronounsPast, personalPronounsPrepositional, interrogativePronouns, interrogativeProAdverbs, interrogativeDeterminers, indefinitePronouns, adverbialGenitives, prepositionalAdverbs, subordinatingConjunctions, delexicalizedVerbs, interviewVerbs, timeWords, vagueNouns, titles, interjections, measurementUnits, miscellaneous, otherAuxiliaries),

		// These word categories cannot directly precede a passive participle.
		cannotDirectlyPrecedePassiveParticiple: [].concat(prepositions, personalPronounsPast, possessivePronouns, cardinalNumerals, ordinalNumerals, delexicalizedVerbs, delexicalisedVerbsInfinitive, interviewVerbs, interrogativeDeterminers, interrogativePronouns, interrogativeProAdverbs),
		...
		all: [].concat(transitionWords, additionalTransitionWords, cardinalNumerals, personalPronounsNominative, personalPronounsAccusative, personalPronounsGenitive, personalPronounsDative, personalPronounsInstrumental, personalPronounsPast, personalPronounsPrepositional, interrogativePronouns, interrogativeProAdverbs, interrogativeDeterminers, indefinitePronouns, adverbialGenitives, otherAuxiliaries, prepositionalAdverbs, subordinatingConjunctions, delexicalizedVerbs, interviewVerbs, timeWords, vagueNouns, titles, interjections, measurementUnits, miscellaneous, passiveAuxiliaries, prepositions, coordinatingConjunctions, demonstrativePronouns, quantifiers, intensifiers, possessivePronouns, reflexivePronounsNominative, reflexivePronounsOther, ordinalNumerals, generalAdjectives, generalAdverbs, delexicalisedVerbsInfinitive, otherAuxiliariesInfinitive, passiveAuxiliariesInfinitive)
	};
};
