...
function replaceStemWithForms(stemOriginalPair, paperWordsGroupedByStems, language) {
	...
	return matchingStemFormPair ? (0, _lodashEs.uniq)([originalSanitized, ...matchingStemFormPair.forms]) : [originalSanitized];
}
...
exports.default = getWordFormsFromText;
//# sourceMappingURL=getWordFormsFromText.js.map
